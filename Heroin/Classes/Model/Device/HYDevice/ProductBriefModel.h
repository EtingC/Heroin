...
@property (nonatomic, copy) NSString *description;//description = "智能手机实时控制查看状态Wi-Fi控制家中电器，小巧精致，是BroadLink目前为止最稳定的一代智能插座产品哦！";
...
@property (nonatomic, copy) NSString *id;//id = 111;
